...
freqA_env1 <- read_csv("data/binomial_bf30/freqA_env1.csv")
freqA_env2 <- read_csv("data/binomial_bf30/freqA_env2.csv")
freqA_env3 <- read_csv("data/binomial_bf30/freqA_env3.csv")
freqA_env4 <- read_csv("data/binomial_bf30/freqA_env4.csv")
freqA_env5 <- read_csv("data/binomial_bf30/freqA_env5.csv")
freqA_env6 <- read_csv("data/binomial_bf30/freqA_env6.csv")
freqA_env7 <- read_csv("data/binomial_bf30/freqA_env7.csv")
freqA_env8 <- read_csv("data/binomial_bf30/freqA_env8.csv")
freqA_env9 <- read_csv("data/binomial_bf30/freqA_env9.csv")

freqB_env1 <- read_csv("data/binomial_bf30/freqB_env1.csv")
freqB_env2 <- read_csv("data/binomial_bf30/freqB_env2.csv")
freqB_env3 <- read_csv("data/binomial_bf30/freqB_env3.csv")
freqB_env4 <- read_csv("data/binomial_bf30/freqB_env4.csv")
freqB_env5 <- read_csv("data/binomial_bf30/freqB_env5.csv")
freqB_env6 <- read_csv("data/binomial_bf30/freqB_env6.csv")
freqB_env7 <- read_csv("data/binomial_bf30/freqB_env7.csv")
freqB_env8 <- read_csv("data/binomial_bf30/freqB_env8.csv")
freqB_env9 <- read_csv("data/binomial_bf30/freqB_env9.csv")
...
###################################################################################
#Export
write_csv(slope_env1, "data/binomial_bf30/slope_obs_env1.csv")
write_csv(slope_env2, "data/binomial_bf30/slope_obs_env2.csv")
write_csv(slope_env3, "data/binomial_bf30/slope_obs_env3.csv")
write_csv(slope_env4, "data/binomial_bf30/slope_obs_env4.csv")
write_csv(slope_env5, "data/binomial_bf30/slope_obs_env5.csv")
write_csv(slope_env6, "data/binomial_bf30/slope_obs_env6.csv")
write_csv(slope_env7, "data/binomial_bf30/slope_obs_env7.csv")
write_csv(slope_env8, "data/binomial_bf30/slope_obs_env8.csv")
write_csv(slope_env9, "data/binomial_bf30/slope_obs_env9.csv")
write_csv(slope_env_all, "data/binomial_bf30/slope_obs_all.csv")
write_csv(slope_env_all_unique, "data/binomial_bf30/slope_obs_all_unique.csv")
