...
basetime_env1 <- read_csv("data/binomial_bf30/env1_low.csv")
basetime_env2 <- read_csv("data/binomial_bf30/env2_low.csv")
basetime_env3 <- read_csv("data/binomial_bf30/env3_low.csv")
basetime_env4 <- read_csv("data/binomial_bf30/env4_low.csv")
basetime_env5 <- read_csv("data/binomial_bf30/env5_low.csv")
basetime_env6 <- read_csv("data/binomial_bf30/env6_low.csv")
basetime_env7 <- read_csv("data/binomial_bf30/env7_low.csv")
basetime_env8 <- read_csv("data/binomial_bf30/env8_low.csv")
basetime_env9 <- read_csv("data/binomial_bf30/env9_low.csv")
...
write_csv(rand_slope_out, "rand_slope_histPop_lowSE_bf30.csv")
