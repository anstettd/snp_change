...
#Import Peak window
snp_set_env1  <- read_csv("snp_set_bf30_env1.csv")
snp_set_env2  <- read_csv("snp_set_bf30_env2.csv")
snp_set_env3  <- read_csv("snp_set_bf30_env3.csv")
snp_set_env4  <- read_csv("snp_set_bf30_env4.csv")
snp_set_env5  <- read_csv("snp_set_bf30_env5.csv")
snp_set_env6  <- read_csv("snp_set_bf30_env6.csv")
snp_set_env7  <- read_csv("snp_set_bf30_env7.csv")
snp_set_env8  <- read_csv("snp_set_bf30_env8.csv")
snp_set_env9  <- read_csv("snp_set_bf30_env9.csv")
