...
write_csv(freq_env1_A_T, "data/binomial_bf30/freqA_env1.csv")
write_csv(freq_env2_A_T, "data/binomial_bf30/freqA_env2.csv")
write_csv(freq_env3_A_T, "data/binomial_bf30/freqA_env3.csv")
write_csv(freq_env4_A_T, "data/binomial_bf30/freqA_env4.csv")
write_csv(freq_env5_A_T, "data/binomial_bf30/freqA_env5.csv")
write_csv(freq_env6_A_T, "data/binomial_bf30/freqA_env6.csv")
write_csv(freq_env7_A_T, "data/binomial_bf30/freqA_env7.csv")
write_csv(freq_env8_A_T, "data/binomial_bf30/freqA_env8.csv")
write_csv(freq_env9_A_T, "data/binomial_bf30/freqA_env9.csv")

write_csv(freq_env1_B_T, "data/binomial_bf30/freqB_env1.csv")
write_csv(freq_env2_B_T, "data/binomial_bf30/freqB_env2.csv")
write_csv(freq_env3_B_T, "data/binomial_bf30/freqB_env3.csv")
write_csv(freq_env4_B_T, "data/binomial_bf30/freqB_env4.csv")
write_csv(freq_env5_B_T, "data/binomial_bf30/freqB_env5.csv")
write_csv(freq_env6_B_T, "data/binomial_bf30/freqB_env6.csv")
write_csv(freq_env7_B_T, "data/binomial_bf30/freqB_env7.csv")
write_csv(freq_env8_B_T, "data/binomial_bf30/freqB_env8.csv")
write_csv(freq_env9_B_T, "data/binomial_bf30/freqB_env9.csv")
