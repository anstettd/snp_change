...
#obs_env1 <- read_csv("data/binomial_bf30/slope_obs_env1.csv") %>% filter(SE<5.5)
#obs_env2 <- read_csv("data/binomial_bf30/slope_obs_env2.csv") %>% filter(SE<5.5)
#obs_env3 <- read_csv("data/binomial_bf30/slope_obs_env3.csv") %>% filter(SE<5.5)
#obs_env4 <- read_csv("data/binomial_bf30/slope_obs_env4.csv") %>% filter(SE<5.5)
#obs_env5 <- read_csv("data/binomial_bf30/slope_obs_env5.csv") %>% filter(SE<5.5)
#obs_env6 <- read_csv("data/binomial_bf30/slope_obs_env6.csv") %>% filter(SE<5.5) %>% filter(Slope>-2.5)
#obs_env7 <- read_csv("data/binomial_bf30/slope_obs_env7.csv") %>% filter(SE<5.5)
#obs_env8 <- read_csv("data/binomial_bf30/slope_obs_env8.csv") %>% filter(SE<5.5)
#obs_env9 <- read_csv("data/binomial_bf30/slope_obs_env9.csv") %>% filter(SE<5.5)
...
obs_env_unique <- read_csv("data/binomial_bf30/slope_obs_all_unique.csv") %>% filter(SE<5.5) %>% filter(Slope>-2.5)
...
rand_env_unique <- read_csv("rand_slope_histPop_lowSE_bf30.csv") %>% filter(Slope <= 2.5 & Slope>= -2.5)  
...
#Export
#write_csv(obs_ci_env, "data/binomial_bf30/obs_ci_env_ab.csv")
write_csv(obs_ci_env_unique, "data/binomial_bf30/obs_ci_env_unique.csv")
