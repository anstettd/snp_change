...
rand_env_unique <- read_csv("rand_slope_histPop_strong.csv") %>% filter(Slope <= 2.5 & Slope>= -2.5)  
...
#Export
#write_csv(obs_ci_env, "data/binomial_strong/obs_ci_env_ab.csv")
write_csv(obs_ci_env_unique, "data/binomial_strong/obs_ci_env_unique.csv")
