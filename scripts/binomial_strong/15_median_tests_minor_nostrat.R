...
rand_env_unique <- read_csv("rand_slope_histPop_strong_minor_no_strat.csv")
...
ggsave("graphs/mean_median_s/Minor/minor_median_nostrat.pdf",width=12, height = 8, units = "in")
...
ggsave("graphs/mean_median_s/Minor/minor_mean_nostrat.pdf",width=12, height = 8, units = "in")
