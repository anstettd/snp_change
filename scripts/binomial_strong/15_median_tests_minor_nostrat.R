...
ggsave("graphs/mean_median_s/50_50/minor_median_nostrat.pdf",width=12, height = 8, units = "in")
...
ggsave("graphs/mean_median_s/50_50/minor_mean_nostrat.pdf",width=12, height = 8, units = "in")
