...
abundA_env1 <- read_csv("data/binomial_bf20/freqA_env1.csv")
abundA_env2 <- read_csv("data/binomial_bf20/freqA_env2.csv")
abundA_env3 <- read_csv("data/binomial_bf20/freqA_env3.csv")
abundA_env4 <- read_csv("data/binomial_bf20/freqA_env4.csv")
abundA_env5 <- read_csv("data/binomial_bf20/freqA_env5.csv")
abundA_env6 <- read_csv("data/binomial_bf20/freqA_env6.csv")
abundA_env7 <- read_csv("data/binomial_bf20/freqA_env7.csv")
abundA_env8 <- read_csv("data/binomial_bf20/freqA_env8.csv")
abundA_env9 <- read_csv("data/binomial_bf20/freqA_env9.csv")

abundB_env1 <- read_csv("data/binomial_bf20/freqB_env1.csv")
abundB_env2 <- read_csv("data/binomial_bf20/freqB_env2.csv")
abundB_env3 <- read_csv("data/binomial_bf20/freqB_env3.csv")
abundB_env4 <- read_csv("data/binomial_bf20/freqB_env4.csv")
abundB_env5 <- read_csv("data/binomial_bf20/freqB_env5.csv")
abundB_env6 <- read_csv("data/binomial_bf20/freqB_env6.csv")
abundB_env7 <- read_csv("data/binomial_bf20/freqB_env7.csv")
abundB_env8 <- read_csv("data/binomial_bf20/freqB_env8.csv")
abundB_env9 <- read_csv("data/binomial_bf20/freqB_env9.csv")
...
slope_env1 <- read_csv("data/binomial_bf20/slope_obs_env1.csv")
slope_env2 <- read_csv("data/binomial_bf20/slope_obs_env2.csv")
slope_env3 <- read_csv("data/binomial_bf20/slope_obs_env3.csv")
slope_env4 <- read_csv("data/binomial_bf20/slope_obs_env4.csv")
slope_env5 <- read_csv("data/binomial_bf20/slope_obs_env5.csv")
slope_env6 <- read_csv("data/binomial_bf20/slope_obs_env6.csv")
slope_env7 <- read_csv("data/binomial_bf20/slope_obs_env7.csv")
slope_env8 <- read_csv("data/binomial_bf20/slope_obs_env8.csv")
slope_env9 <- read_csv("data/binomial_bf20/slope_obs_env9.csv")
...
#Export
write_csv(env1_low, "data/binomial_bf20/env1_low.csv")
write_csv(env2_low, "data/binomial_bf20/env2_low.csv")
write_csv(env3_low, "data/binomial_bf20/env3_low.csv")
write_csv(env4_low, "data/binomial_bf20/env4_low.csv")
write_csv(env5_low, "data/binomial_bf20/env5_low.csv")
write_csv(env6_low, "data/binomial_bf20/env6_low.csv")
write_csv(env7_low, "data/binomial_bf20/env7_low.csv")
write_csv(env8_low, "data/binomial_bf20/env8_low.csv")
write_csv(env9_low, "data/binomial_bf20/env9_low.csv")
