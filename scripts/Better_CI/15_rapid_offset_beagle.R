...
library(car) 
#Import data
offset_pop <- read_csv("data/time_cumul_beagle_95.csv")
...
ggsave("graphs/bi_plots_95/1_rapid_offset_1215_pos.pdf",width=7, height = 6, units = "in")
...
ggplot(offset_pop, aes(x=offset_1215, y=cumul_all, label=Paper_ID)) + 
  ...
  theme_classic() + theme(
    ...
    legend.position = c(0.85, 0.85),legend.text=element_text(size=14),
    legend.title=element_text(size=16,face="bold"))
ggsave("graphs/bi_plots_95/2_rapid_offset_1215_all.pdf",width=7, height = 6, units = "in")
...
ggplot(offset_pop, aes(x=offset_SSP245, y=cumul_pos, label=Paper_ID)) + 
  ...
  theme_classic() + theme(
    ...
    legend.title=element_text(size=16,face="bold"))
ggsave("graphs/bi_plots_95/3_rapid_offset_ssp245_pos.pdf",width=7, height = 6, units = "in")
...
ggplot(offset_pop, aes(x=offset_SSP245, y=cumul_all, label=Paper_ID)) + 
  ...
  theme_classic() + theme(
    ...
    legend.position = c(0.65, 0.85),legend.text=element_text(size=14),
    legend.title=element_text(size=16,face="bold"))
ggsave("graphs/bi_plots_95/4_rapid_offset_ssp245_all.pdf",width=7, height = 6, units = "in")
...
ggplot(offset_pop, aes(x=offset_SSP585, y=cumul_pos, label=Paper_ID)) + 
  ...
  theme_classic() + theme(
    ...
    legend.position = c(0.65, 0.85),legend.text=element_text(size=14),
    legend.title=element_text(size=16,face="bold"))
ggsave("graphs/bi_plots_95/5_rapid_offset_ssp585_pos.pdf",width=7, height = 6, units = "in")
...
ggplot(offset_pop, aes(x=offset_SSP585, y=cumul_all, label=Paper_ID)) + 
  ...
  theme_classic() + theme(
    ...
    legend.position = c(0.65, 0.85),legend.text=element_text(size=14),
    legend.title=element_text(size=16,face="bold"))
ggsave("graphs/bi_plots_95/6_rapid_offset_ssp585_all.pdf",width=7, height = 6, units = "in")
...
ggplot(offset_pop, aes(x=offset_climate, y=cumul_pos, label=Paper_ID)) + 
  ...
  theme_classic() + theme(
    ...
    legend.position = c(0.85, 0.85),legend.text=element_text(size=14),
    legend.title=element_text(size=16,face="bold"))
ggsave("graphs/bi_plots_95/7_rapid_offset_climate_distance_all.pdf",width=7, height = 6, units = "in")
...
ggplot(offset_pop, aes(x=offset_climate, y=cumul_all, label=Paper_ID)) + 
  ...
  theme_classic() + theme(
    ...
    legend.position = c(0.85, 0.85),legend.text=element_text(size=14),
    legend.title=element_text(size=16,face="bold"))
ggsave("graphs/bi_plots_95/8_rapid_offset_climate_distance_pos.pdf",width=7, height = 6, units = "in")
