...
#Import files
env_obs_ci_unique <- read_csv("data/obs_ci_env_unique_95.csv")
...
histPop
ggsave("graphs/04_slope_ci_histPop_95.pdf",width=12, height = 8, units = "in")
...
histPop <- ggplot(env_histPop_25 ,aes(x=S,y=obs,ymin=low,ymax=high))+
  ...
  theme_ci() + facet_wrap(.~pop_lable)
histPop
ggsave("graphs/05_slope_ci_histPop_95_2.5.pdf",width=12, height = 8, units = "in")
