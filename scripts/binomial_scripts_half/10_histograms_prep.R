...
obs_env1 <- read_csv("data/binomial_data_half/slope_obs_env1.csv") %>% filter(SE<5.5)
obs_env2 <- read_csv("data/binomial_data_half/slope_obs_env2.csv") %>% filter(SE<5.5)
obs_env3 <- read_csv("data/binomial_data_half/slope_obs_env3.csv") %>% filter(SE<5.5)
obs_env4 <- read_csv("data/binomial_data_half/slope_obs_env4.csv") %>% filter(SE<5.5)
obs_env5 <- read_csv("data/binomial_data_half/slope_obs_env5.csv") %>% filter(SE<5.5)
obs_env6 <- read_csv("data/binomial_data_half/slope_obs_env6.csv") %>% filter(SE<5.5) %>% filter(Slope>-2.5)
obs_env7 <- read_csv("data/binomial_data_half/slope_obs_env7.csv") %>% filter(SE<5.5)
obs_env8 <- read_csv("data/binomial_data_half/slope_obs_env8.csv") %>% filter(SE<5.5)
...
rand_env1 <- read_csv("rand_slope_env1_ab_lowSE.csv") %>% mutate(Slope=Slope/2) %>% filter(Slope <= 2.5 & Slope>= -2.5)
rand_env2 <- read_csv("rand_slope_env2_ab_lowSE.csv") %>% mutate(Slope=Slope/2) %>% filter(Slope <= 2.5 & Slope>= -2.5) 
rand_env3 <- read_csv("rand_slope_env3_ab_lowSE.csv") %>% mutate(Slope=Slope/2) %>% filter(Slope <= 2.5 & Slope>= -2.5) 
rand_env4 <- read_csv("rand_slope_env4_ab_lowSE.csv") %>% mutate(Slope=Slope/2) %>% filter(Slope <= 2.5 & Slope>= -2.5) 
rand_env5 <- read_csv("rand_slope_env5_ab_lowSE.csv") %>% mutate(Slope=Slope/2) %>% filter(Slope <= 2.5 & Slope>= -2.5) 
rand_env6 <- read_csv("rand_slope_env6_ab_lowSE.csv") %>% mutate(Slope=Slope/2) %>% filter(Slope <= 2.5 & Slope>= -2.5) 
rand_env7 <- read_csv("rand_slope_env7_ab_lowSE.csv") %>% mutate(Slope=Slope/2) %>% filter(Slope <= 2.5 & Slope>= -2.5) 
rand_env8 <- read_csv("rand_slope_env8_ab_lowSE.csv") %>% mutate(Slope=Slope/2) %>% filter(Slope <= 2.5 & Slope>= -2.5) 
