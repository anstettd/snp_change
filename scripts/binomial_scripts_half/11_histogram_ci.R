...
#Import files
env_obs_ci <- read_csv("data/binomial_data_half/obs_ci_env_ab.csv")
...
mat_p1_hist 
ggsave("graphs/slopes_CI_half_95/01_slope_ci_p1.pdf",width=12, height = 8, units = "in")
...
mat_p12_hist <- ggplot(env_obs_ci,aes(x=S,y=p12,ymin=p12_low,ymax=p12_up))+
  ...
  scale_y_continuous(limits=c(0,40))+ theme_ci() + facet_wrap(.~env)
mat_p12_hist 
ggsave("graphs/slopes_CI_half_95/02_slope_ci_p12.pdf",width=12, height = 8, units = "in")
...
mat_p2_hist <- ggplot(env_obs_ci,aes(x=S,y=p2,ymin=p2_low,ymax=p2_up))+
  ...
  scale_y_continuous(limits=c(0,40))+ theme_ci() + facet_wrap(.~env)
mat_p2_hist 
ggsave("graphs/slopes_CI_half_95/03_slope_ci_p2.pdf",width=12, height = 8, units = "in")
...
mat_p3_hist <- ggplot(env_obs_ci,aes(x=S,y=p3,ymin=p3_low,ymax=p3_up))+
  ...
  scale_y_continuous(limits=c(0,40))+ theme_ci() + facet_wrap(.~env)
mat_p3_hist 
ggsave("graphs/slopes_CI_half_95/04_slope_ci_p3.pdf",width=12, height = 8, units = "in")
...
mat_p4_hist <- ggplot(env_obs_ci,aes(x=S,y=p4,ymin=p4_low,ymax=p4_up))+
  ...
  scale_y_continuous(limits=c(0,40))+ theme_ci() + facet_wrap(.~env)
mat_p4_hist 
ggsave("graphs/slopes_CI_half_95/05_slope_ci_p4.pdf",width=12, height = 8, units = "in")
...
mat_p5_hist <- ggplot(env_obs_ci,aes(x=S,y=p5,ymin=p5_low,ymax=p5_up))+
  ...
  scale_y_continuous(limits=c(0,40))+ theme_ci() + facet_wrap(.~env)
mat_p5_hist 
ggsave("graphs/slopes_CI_half_95/06_slope_ci_p5.pdf",width=12, height = 8, units = "in")
...
mat_p6_hist <- ggplot(env_obs_ci,aes(x=S,y=p6,ymin=p6_low,ymax=p6_up))+
  ...
  scale_y_continuous(limits=c(0,40))+ theme_ci() + facet_wrap(.~env)
mat_p6_hist 
ggsave("graphs/slopes_CI_half_95/07_slope_ci_p6.pdf",width=12, height = 8, units = "in")
...
mat_p7_hist <- ggplot(env_obs_ci,aes(x=S,y=p7,ymin=p7_low,ymax=p7_up))+
  ...
  scale_y_continuous(limits=c(0,40))+ theme_ci() + facet_wrap(.~env)
mat_p7_hist 
ggsave("graphs/slopes_CI_half_95/08_slope_ci_p7.pdf",width=12, height = 8, units = "in")
...
mat_p8_hist <- ggplot(env_obs_ci,aes(x=S,y=p8,ymin=p8_low,ymax=p8_up))+
  ...
  scale_y_continuous(limits=c(0,40))+ theme_ci() + facet_wrap(.~env)
mat_p8_hist 
ggsave("graphs/slopes_CI_half_95/09_slope_ci_p8.pdf",width=12, height = 8, units = "in")
...
mat_p9_hist <- ggplot(env_obs_ci,aes(x=S,y=p9,ymin=p9_low,ymax=p9_up))+
  ...
  scale_y_continuous(limits=c(0,40))+ theme_ci() + facet_wrap(.~env)
mat_p9_hist 
ggsave("graphs/slopes_CI_half_95/10_slope_ci_p9.pdf",width=12, height = 8, units = "in")
...
mat_p10_hist <- ggplot(env_obs_ci,aes(x=S,y=p10,ymin=p10_low,ymax=p10_up))+
  ...
  scale_y_continuous(limits=c(0,40))+ theme_ci() + facet_wrap(.~env)
mat_p10_hist 
ggsave("graphs/slopes_CI_half_95/11_slope_ci_p10.pdf",width=12, height = 8, units = "in")
...
mat_p11_hist <- ggplot(env_obs_ci,aes(x=S,y=p11,ymin=p11_low,ymax=p11_up))+
  ...
  scale_y_continuous(limits=c(0,40))+ theme_ci() + facet_wrap(.~env)
mat_p11_hist 
ggsave("graphs/slopes_CI_half_95/12_slope_ci_p11.pdf",width=12, height = 8, units = "in")
