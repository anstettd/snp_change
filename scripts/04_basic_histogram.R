...
env_low <- env_all %>% filter(SE<5) %>% filter(SE>-5)
...
env_hist
ggsave("graphs/01_slope_obs_p1.pdf",width=10, height = 7.5, units = "in")
...
env_hist <- env_hist + facet_wrap(.~ENV)
env_hist
ggsave("graphs/02_slope_obs_p12.pdf",width=10, height = 7.5, units = "in")
...
env_hist <- env_hist + facet_wrap(.~ENV)
env_hist
ggsave("graphs/03_slope_obs_p2.pdf",width=10, height = 7.5, units = "in")
...
env_hist <- env_hist + facet_wrap(.~ENV)
env_hist
ggsave("graphs/04_slope_obs_p3.pdf",width=10, height = 7.5, units = "in")
...
env_hist <- env_hist + facet_wrap(.~ENV)
env_hist
ggsave("graphs/05_slope_obs_p4.pdf",width=10, height = 7.5, units = "in")
...
env_hist <- env_hist + facet_wrap(.~ENV)
env_hist
ggsave("graphs/06_slope_obs_p5.pdf",width=10, height = 7.5, units = "in")
...
env_hist <- env_hist + facet_wrap(.~ENV)
env_hist
ggsave("graphs/07_slope_obs_p6.pdf",width=10, height = 7.5, units = "in")
...
env_hist <- env_hist + facet_wrap(.~ENV)
env_hist
ggsave("graphs/08_slope_obs_p7.pdf",width=10, height = 7.5, units = "in")
...
env_hist <- env_hist + facet_wrap(.~ENV)
env_hist
ggsave("graphs/09_slope_obs_p8.pdf",width=10, height = 7.5, units = "in")
...
env_hist <- env_hist + facet_wrap(.~ENV)
env_hist
ggsave("graphs/10_slope_obs_p9.pdf",width=10, height = 7.5, units = "in")
...
env_hist <- env_hist + facet_wrap(.~ENV)
env_hist
ggsave("graphs/11_slope_obs_p10.pdf",width=10, height = 7.5, units = "in")
...
env_hist <- env_hist + facet_wrap(.~ENV)
env_hist
ggsave("graphs/12_slope_obs_p11.pdf",width=10, height = 7.5, units = "in")
