...
abund_clim <- read_csv("/Users/daniel_anstett/Dropbox/AM_Workshop/Large_files/abund_table_baseline_WZA.csv",
                       col_names = T)
...
ggsave("graphs/spaghetii/3_spaghetii_baseline_WZA_lat.pdf",width=8, height = 7, units = "in")
