...
basetime_env1 <- read_csv("data/binomial_wza/env1_low.csv")
basetime_env2 <- read_csv("data/binomial_wza/env2_low.csv")
basetime_env3 <- read_csv("data/binomial_wza/env3_low.csv")
basetime_env4 <- read_csv("data/binomial_wza/env4_low.csv")
basetime_env5 <- read_csv("data/binomial_wza/env5_low.csv")
basetime_env6 <- read_csv("data/binomial_wza/env6_low.csv")
basetime_env7 <- read_csv("data/binomial_wza/env7_low.csv")
basetime_env8 <- read_csv("data/binomial_wza/env8_low.csv")
basetime_env9 <- read_csv("data/binomial_wza/env9_low.csv")
...
write_csv(rand_slope_out, "rand_slope_histPop_lowSE_wza.csv")
